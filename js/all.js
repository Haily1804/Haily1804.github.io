...
<div class="collapse navbar-collapse col-10 col-md-10" id="nav-bar">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0 col-md-10 justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link" href="../html/blog.html">Tin tức</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../html/lienhe.html">Liên hệ</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../html/aboutUs.html">Về chúng tôi</a>
        </li>
        <li class="nav-item">
...
<div class="row justify-content-center">
    ...
    <div class="col-md-2">
        ...
        <a href="../html/eror.html">Chính sách bán hàng</a>
        <a href="../html/eror.html">Theo dõi đơn hàng</a>
    </div>
    <div class="col-md-3">
